...
export default function HeroSection() {
  ...
  return (
    <section className="relative flex flex-col items-center justify-center text-center py-24 px-4 min-h-screen bg-gradient-to-b from-black via-zinc-900 to-black overflow-hidden">
      <ThreeBackground />
